...
- 🎓 B.Tech Computer Engineering student at **Pandit Deendayal Energy University (PDEU)** — CGPA: **8.64 / 10**
- 🏗️ Passionate about building scalable full-stack applications with clean architecture and solid engineering principles
- ⚙️ Strong interest in **Backend Development**, **AI integration**, and modern **Software Engineering** practices
- ⚔️ Enthusiast of **Competitive Programming** and **Data Structures & Algorithms**
- 🚀 Actively building real-world projects across the full stack — from REST APIs to React frontends
- 📖 Continuously learning and exploring new technologies, frameworks, and system design concepts
...
![Yargs](https://img.shields.io/badge/Yargs-000000?style=flat-square&logo=npm&logoColor=white)
